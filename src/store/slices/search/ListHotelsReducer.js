...
export default function SearchHotelListReducer(
  state = defaultHotelList,
  { type, payload }
) {
  switch (type) {
    case SEARCHLISTHOTELS:
      return { ...state, hotelsList: payload, errorGetHotels: false };
    case ERROR:
      return { ...state, errorGetHotels: true };
    default:
      return state;
  }
}
