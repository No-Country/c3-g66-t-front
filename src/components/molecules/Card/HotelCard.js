...
function HotelCard({ title, city, country, mainImg, id: hotelId, price }) {
  ...
  return (
    <div className="group h-full bg-withe-700 flex flex-wrap rounded-lg shadow-xl relative overflow-hidden  flex-row transform hover:scale-125 transition-all">
