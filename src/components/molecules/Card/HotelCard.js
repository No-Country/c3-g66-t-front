...
function HotelCard({ title, city, country, mainImg, id: hotelId, price }) {
  ...
  // };
  return (
    <div className="group w-48 h-48 bg-withe-700 flex flex-wrap rounded-lg shadow-xl relative overflow-hidden  flex-row transform hover:scale-125 transition-all">
